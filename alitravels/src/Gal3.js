  ...
  return (
    <div className="photo-gallery">
      <div className="photo-container" onClick={() => handleAnimation('photo1')}>
        <img className="photo" id="photo1" src="./Max7.JPG" alt="Photo 1" />
        <div className="overlay">Hushe</div>
      </div>
      <div className="photo-container" onClick={() => handleAnimation('photo2')}>
        <img className="photo" id="photo2" src="./Max9.JPG" alt="Photo 2" />
        <div className="overlay"></div>
      </div>
      <div className="photo-container" onClick={() => handleAnimation('photo3')}>
        <img className="photo" id="photo3" src="./Max8.JPG" alt="Photo 3" />
        <div className="overlay"></div>
      </div>
    </div>
  );
